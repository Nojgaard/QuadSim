...
public class SimplestPlot : MonoBehaviour
{
    ...
    // PLot variables
    public List<SeriesClass> SeriesPlotY = new List<SeriesClass>();
    public float[] SeriesPlotX;
    public List<DistributionClass> DistributionPlot = new List<DistributionClass>();
    private List<float[]> ActualDistribution = new List<float[]>();
    public List<PhaseSpaceClass> PhaseSpacePlot = new List<PhaseSpaceClass>();
    ...
    private void SetupText()
    {
        ...
        PlotYMaxText.font = TextFont;
        PlotYMinText.font = TextFont;
        PlotXMaxText.font = TextFont;
        PlotXMinText.font = TextFont;
        WarningText.font = TextFont;
